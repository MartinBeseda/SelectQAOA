...
if __name__ == '__main__':
    ...
    for file_name in ["gsdtsr","iofrol","paintcontrol"]:
        ...
        if not os.path.exists("../results/igdec_qaoa/ideal/qaoa_"+str(reps)+"/" + file_name + "/size_" + str(problem_size) + "/" + str(num_experiment)):
            os.makedirs("../results/igdec_qaoa/ideal/qaoa_"+str(reps)+"/" + file_name + "/size_" + str(problem_size) + "/" + str(num_experiment))
        result_df.to_csv("../results/igdec_qaoa/ideal/qaoa_"+str(reps)+"/" + file_name + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/itr_results.csv")

        if not os.path.exists("../results/igdec_qaoa/ideal/qaoa_"+str(reps)+"/" + file_name + "/size_" + str(problem_size) + "/" + str(num_experiment)):
            os.makedirs("../results/igdec_qaoa/ideal/qaoa_"+str(reps)+"/" + file_name + "/size_" + str(problem_size) + "/" + str(num_experiment))
        solution_df.to_csv("../results/igdec_qaoa/ideal/qaoa_"+str(reps)+"/" + file_name + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/solution.csv")
