...
def plot(fval_list, reps, file_name, problem_size):
    plt.plot(fval_list)
    plt.ylabel('fval')
    plt.savefig("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name + "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/fval_trend.png")
...
if __name__ == '__main__':
    ...
    file_name = "elevator"
    df = pd.DataFrame()
    df = pd.read_csv("../datasets/quantum_sota_datasets/"+file_name+".csv", dtype={"cost": float, "input_div": float})
    length = len(df)
    ...
    head_solution = ["best_itr", "best_fval", "best_solution", "total_qaoa", "total_impact","total_exe", "execution_times", "final_test_suite_costs", "final_suite_input_divs"]
    ...
    while count < 10:
        ...
        best_itr_input_divs.append(df.loc[np.array(best_solution) == 1, "input_div"].sum())
    ...
    if not os.path.exists("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)):
        os.makedirs("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment))
    log_df.to_csv("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/log.csv")

    if not os.path.exists("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)):
        os.makedirs("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment))
    result_df.to_csv("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/itr_results.csv")

    if not os.path.exists("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)):
        os.makedirs("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment))
    solution_df.to_csv("../results/igdec_qaoa/noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/solution.csv")
