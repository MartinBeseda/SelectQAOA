...
configs <- list(
  ideal = list(
    flex = list(
      ...
      qaoa = c(486, 496, 495, 491, 494, 491, 495, 485, 495, 487),
  ...
  statevector = list(
    flex = list(
      qtcs = c(173, 173, 173, 173, 173, 173, 173, 173, 173, 173),
      div_ga = c(136, 140, 139, 139, 140, 139, 134, 138, 137, 139),
      qaoa = c(411, 403, 418, 365, 389, 442, 385, 416, 439, 414),
      add_greedy = c(89, 89, 89, 89, 89, 89, 89, 89, 89, 89)
    ),
    grep = list(
